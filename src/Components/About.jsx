...
function About() {
  return (
    <div className='px-8 flex flex-col gap-14 text-[#EEEEEE] bg-[#222831] md:grid grid-cols-2'>
        <div className='text-lg font-[600] flex flex-col justify-center gap-8 md:text-2xl'>
            ...
            <div className='flex flex-row gap-8 items-center'><div><FaCode className='size-7 text-[#00ADB5]'/></div><div>App Development</div></div>
            <div className='flex flex-row gap-8 items-center'><div><FaCode className='size-7 text-[#00ADB5]'/></div><div>Website Development</div></div>
            <div className='flex flex-row gap-8 items-center'><div><FaCode className='size-7 text-[#00ADB5]'/></div><div>Website Development</div></div>
        </div>
